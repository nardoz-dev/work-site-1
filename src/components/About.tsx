        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h2 className="text-3xl lg:text-4xl text-foreground mb-4">
              Competenza ed <span className="text-blue-600">Esperienza</span> al Tuo Servizio
            </h2>
          </div>
          ...
          <div className="grid lg:grid-cols-[300px_1fr] gap-12 items-start">
            ...
            <div className="hidden lg:block">
              <div className="relative group">
                {/* Main card */}
                <div className="relative bg-primary dark:bg-blue-800 p-8 rounded-3xl shadow-2xl group-hover:shadow-blue-500/20 transition-all duration-500">
            ...
            <div className="space-y-8">
              ...
              <div className="grid sm:grid-cols-3 gap-4 pt-4">
                <div className="group relative overflow-hidden bg-white dark:bg-gray-900 p-6 rounded-xl border border-gray-200 dark:border-gray-700 hover:border-primary dark:hover:border-blue-500 transition-all duration-300 hover:shadow-lg hover:shadow-blue-600/10">
                  <div className="relative">
                    <CheckCircle className="w-6 h-6 text-primary dark:text-blue-400 mb-3 group-hover:scale-110 transition-transform duration-300" />
                    <p className="text-foreground">Esperienza Pluriennale</p>
                  </div>
                </div>
                 ...
                 <div className="relative">
                    <CheckCircle className="w-6 h-6 text-primary dark:text-blue-400 mb-3 group-hover:scale-110 transition-transform duration-300" />
                    <p className="text-foreground">Approccio Strutturato</p>
                  </div>
                </div>
                ...
                <div className="group relative overflow-hidden bg-white dark:bg-gray-900 p-6 rounded-xl border border-gray-200 dark:border-gray-700 hover:border-primary dark:hover:border-blue-500 transition-all duration-300 hover:shadow-lg hover:shadow-blue-600/10">
                  <div className="relative">
                    <CheckCircle className="w-6 h-6 text-primary dark:text-blue-400 mb-3 group-hover:scale-110 transition-transform duration-300" />
                    <p className="text-foreground">Interventi Tempestivi</p>
                  </div>
                </div>
              </div>
            </div>
