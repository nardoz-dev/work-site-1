  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-gray-900/25 via-blue-200/50 to-gray-950/90 dark:from-gray-700/90 dark:via-blue-950/85 dark:to-gray-950/90" />
      </div>
