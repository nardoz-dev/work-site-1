  ...
  return (
    <footer className="bg-gray-700 dark:bg-[#1d1d1f] border-t border-border/50 transition-colors duration-500">
        ...
        <div className="container mx-auto px-4">
            ...
            className="w-full py-4 group flex items-center justify-center gap-2 text-white hover:text-white/70 dark:hover:text-blue-500 transition-colors"
            >
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-2 gap-12 max-w-4xl mx-auto">
          ...
          {/* Social Media */}
          <div>
            <h4 className="text-foreground mb-6 text-white">Seguici</h4>
